...
public class LocationPickerActivity extends Activity implements PermissionsListener, OnMapReadyCallback {
                ...
                selectLocationButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        new AlertDialog.Builder(LocationPickerActivity.this)
                                .setMessage("Apakah anda yakin ingin menyimpan lokasi ini?")
            ...
            client.enqueueCall(new Callback<GeocodingResponse>() {
                ...
                public void onResponse(Call<GeocodingResponse> call, Response<GeocodingResponse> response) {
                    ...
                    if (response.body() != null) {
                        List<String> result = response.body().query();
                        //Toast.makeText(LocationPickerActivity.this, resultst.get(0) + " | " + resultst.get(1), Toast.LENGTH_LONG).show();
                        if (result.size() > 0) {
                            Geocoder geocoder;
                            ...
                            try {
                                addresses = geocoder.getFromLocation(Double.parseDouble(result.get(1)), Double.parseDouble(result.get(0)), 1); // Here 1 represent max location result to returned, by documents it recommended 1 to 5
                                ...
                                resultIntent.putExtra("alamat", address);
                                resultIntent.putExtra("latitude", result.get(1));
                                resultIntent.putExtra("longitude", result.get(0));
                                setResult(Activity.RESULT_OK, resultIntent);
                                finish();

                                //Toast.makeText(LocationPickerActivity.this, "Address: " + address, Toast.LENGTH_SHORT).show();
                            } catch (IOException e) {
                                e.printStackTrace();
                            }

                            //Toast.makeText(LocationPickerActivity.this, "Latitude: " + result.get(1) + " & Longitude: " + result.get(0), Toast.LENGTH_LONG).show();
                        } else {
